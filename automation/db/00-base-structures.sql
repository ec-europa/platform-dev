...
CREATE TABLE IF NOT EXISTS drupal_master_sites (
  ...
  default_subsite_hostname_pattern varchar(512) DEFAULT NULL COMMENT 'pattern used to compute the URL of a new subsite (host part)',
  default_subsite_uri_pattern varchar(512) DEFAULT NULL COMMENT 'pattern used to compute the URL of a new subsite (request URI part)',
  default_subsite_http tinyint(1) DEFAULT '0' COMMENT 'used to compute the URL of a new subsite (whether HTTP protocol is handled)',
  default_subsite_https tinyint(1) DEFAULT '1' COMMENT 'used to compute the URL of a new subsite (whether HTTPS protocol is handled)',
  default_subsite_install_policy varchar(128) NOT NULL,
  default_subsite_install_variant varchar(128) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS drupal_subsites (
  ...
  install_variant varchar(128) DEFAULT NULL,
