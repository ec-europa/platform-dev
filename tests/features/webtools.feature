...
Feature: Webtools feature
  ...
  Scenario: Insert a webtools block into a content and delete a block 'Twitter'
    ...
    And the response should contain "<script type=\"application/json\">{\"service\":\"twitter\",\"type\": \"user\"}</script>"
    ...
    And I fill in the content's title with "Basic page with Twitter"
    ...
    And I click "delete" in the "Block Twitter Webtools" row
    Then I should see "Are you sure you want to delete Block Twitter Webtools Title?"
    When I press "Delete"
    Then I should see the success message "webtools Block Twitter Webtools Title has been deleted."
