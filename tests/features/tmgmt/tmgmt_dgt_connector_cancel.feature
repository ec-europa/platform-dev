...
Feature: TMGMT Poetry Client features including language canceled
  ...
  @javascript
  Scenario: I can cancel language in request using Poetry Client.
    ...
    <POETRY xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="">
       <request communication="synchrone" id="1071819" type="status">
          ...
          <status code="0" type="request">
             <statusDate>19/10/2019</statusDate>
          ...
          <attributions format="HTML" lgCode="ES">
             <attributionsDelai>31/10/2019 23:59</attributionsDelai>
             <attributionsDelaiAccepted>31/10/2019 23:59</attributionsDelaiAccepted>
          </attributions>
    ...
    Then I should see "In progress" in the "Spanish" row
    ...
    <POETRY xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="">
       <request communication="synchrone" id="1071819" type="status">
          ...
          <status code="CNL" lgCode="ES" type="attribution">
             <statusDate>19/10/2019</statusDate>
             <statusTime>00:00:00</statusTime>
          </status>
          <status code="ONG" lgCode="FR" type="attribution">
