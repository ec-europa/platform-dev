...
Feature: multisite media gallery og
  ...
  Background:
    ...
    And   I fill in "Title" with "My test gallery"
    ...
    And   I press "Save"
    Then  I should see the text "Media Gallery My test gallery has been created."
  ...
  Scenario: as user I can browse the media gallery
    ...
    And   I should see "My test gallery"
    When  I click "My test gallery"
    Then  I should see the heading "My test gallery"
    And   I should see "My picture"
    When  I click "My picture"
    Then  the page should contain the element with following id "lightbox0" and given attributes:
      | Attribute | Value           |
  ...
  #   And   I click "Public community 1"
  #   And   I click "Media Gallery" in the "sidebar_left" region
  #   Then  I should see "My test gallery"
  #   Then  I should see "Media gallery 1"
  #   And   I should see "Media gallery 2"
  #   And   I should see "Media gallery 3"
