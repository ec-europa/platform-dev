...
Feature: Content editing as administrator
  ...
  Scenario Outline: Test allowed HTML
    ...
    Examples:
      ...
      | <p style=\"text-align:right\">The right way</p>                                              | .ecl-field__body    | <p style=\"text-align:right\">The right way</p>                                              |
      | <p><span style=\"font-family:courier\"><span style=\"font-size:18px\"><strong>Fancy</strong> | .ecl-field__body    | <p><span style=\"font-family:courier\"><span style=\"font-size:18px\"><strong>Fancy</strong> |
      | <p><span style=\"color:#800000\"><em><u>Yay!</u></em></span></p>                             | .ecl-field__body    | <p><span style=\"color:#800000\"><em><u>Yay!</u></em></span></p>                             |
      | <pre>Preformatted text</pre>                                                                 | .ecl-field__body    | <pre>Preformatted text</pre>                                                                 |
      | <blockquote>A quote</blockquote>                                                             | .ecl-field__body    | <blockquote><p>A quote</p></blockquote>                                                      |
      | <ul><li>A bullet!</li></ul>                                                                  | .ecl-field__body ul | <li>A bullet!</li>                                                                           |
      | <ol><li>A number?</li></ol>                                                                  | .ecl-field__body ol | <li>A number?</li>                                                                           |
      | <p><a href=\"http://www.europa.eu/newsroom\">The latest news</a></p>                         | .ecl-field__body    | <p><a href=\"http://www.europa.eu/newsroom\">The latest news</a></p>                         |
      | <h2 style=\"font-style:italic\">Styled heading</h2>                                          | .ecl-field__body    | <h2 style=\"font-style:italic\">Styled heading</h2>                                          |
      | <div class=\"css_class-name\">Applied css class</div>                                        | .ecl-field__body    | <div class=\"css_class-name\">Applied css class</div>                                        |
      | <div id=\"my-id_123\">A container with a custom HTML ID.</div>                               | .ecl-field__body    | <div id=\"my-id_123\">A container with a custom HTML ID.</div>                               |
      | <dl><dt>List Title</dt><dd>List item</dd></dl>                                               | .ecl-field__body    | <dt>List Title</dt>                                                                          |
      | <div id=\"2validid\">A container with an valid HTML ID</div>                                 | .ecl-field__body    | 2validid                                                                                     |
