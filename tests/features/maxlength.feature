Feature: Check the feature Maxlength
  ...
  Scenario: Contributor User can check the maxlength counts (without the tags and specifics characters) and Administrator User can check his bypass.
    ...
    Then I should see the success message "Updated field Test Maxlength field settings."
    When I fill in "edit-instance-widget-settings-maxlength-js" with "10"
    And I check "Truncate html"
    And I press "Save settings"
    Then I should see the success message "Saved Test Maxlength configuration."
