...
(function ($) {
    $(document).ready(function () {
        ...
        $(".view-ne-faq .views-field-title").click(function () {
            ...
            $(this).next(".views-field-field-ne-body").slideToggle("slow");
            $(this).next(".views-field-field-ne-body").next(".views-field-field-tags").slideToggle("slow");
        ...
        $(".view-ne-faq .views-field-field-ne-body").css("display", "none");
        $(".view-ne-faq .views-field-field-tags").css("display", "none");

        // Expand.
        $(".view-ne-faq a.action-expand").click(function () {
            $(".view-ne-faq .views-field-field-ne-body").slideDown("slow");
        ...
        $(".view-ne-faq a.action-collapse").click(function () {
            $(".view-ne-faq .views-field-field-ne-body").slideUp("slow");
