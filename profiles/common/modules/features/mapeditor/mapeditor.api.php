...
/**
 * @file
 * Documentation for mapeditor API.
 */
 ...
 * defined by mapeditor_layer or other custom layer modules by
  ...
  if ($entity->type == 'user_layer') {
    ...
    if ($users) {
      $layers[] = array(
        ...
        'users' => $users,
        'id' => _mapeditor_layer_id($wrapper->title->value()),
      );
