 ...
 *
 * Regions:
 * - $page['header']: Displayed in the right part of the header
 *                    -> logo, search box, ...
 * - $page['header_bottom']: Displayed below the header, take full width of site
 *                           -> main menu, global information, breadcrumb...
 * - $page['highlighted']: Displayed in a big visible box
 *                         -> important message, contextual information, ...
