 ...
 * Preprocess hook.
 */
function ec_resp_151_preprocess(&$variables) {
  // Select template
  // 'ec' or 'europa'.
 ...
 */
function ec_resp_151_preprocess_node(&$variables) {
 ...
 */
function ec_resp_151_preprocess_block(&$variables) {
 ...
 */
function ec_resp_151_preprocess_select(&$variables) {
 ...
 */
function ec_resp_151_preprocess_textfield(&$variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
}
 ...
 */
function ec_resp_151_preprocess_password(&$variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
}
 ...
 */
function ec_resp_151_preprocess_textarea(&$variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
}
 ...
 */
function ec_resp_151_preprocess_maintenance_page(&$variables) {
  if (!$variables['db_is_active']) {
    unset($variables['site_name']);
  }
  drupal_add_css(drupal_get_path('theme', 'ec_resp_151') . '/css/maintenance-page.css');
}

/**
 * Preprocess html hook.
 */
function ec_resp_151_preprocess_html(&$variables) {
  ...
  $element = array(
    '#tag' => 'link',
    '#attributes' => array(
      'href' => $base_url . '/' . drupal_get_path('theme', 'ec_resp_151') . '/css/text_size_small.css',
      'rel' => 'stylesheet',
      'type' => 'text/css',
      'data-name' => 'switcher',
    ),
  ...
  drupal_add_css(drupal_get_path('theme', 'ec_resp_151') . '/css/ie.css', array(
    'group' => CSS_THEME,
    'browsers' => array(
      'IE' => 'lte IE 7',
      '!IE' => FALSE),
  ...
  // Add javascripts.
  drupal_add_js(drupal_get_path('theme', 'ec_resp_151') . '/scripts/respond.min.js', array('scope' => 'header', 'weight' => 1));
  drupal_add_js(drupal_get_path('theme', 'ec_resp_151') . '/scripts/ec.js', array('scope' => 'footer', 'weight' => 10));
  drupal_add_js(drupal_get_path('theme', 'ec_resp_151') . '/scripts/jquery.mousewheel-3.0.6.pack.js', array('scope' => 'footer', 'weight' => 11));
  drupal_add_js(drupal_get_path('theme', 'ec_resp_151') . '/scripts/scripts.js', array('scope' => 'footer', 'weight' => 12));
  drupal_add_js(drupal_get_path('theme', 'ec_resp_151') . '/scripts/hack.js', array('scope' => 'footer', 'weight' => 13));
}

/**
 * Preprocess menu link hook.
 */
function ec_resp_151_preprocess_menu_link(&$variables) {
 ...
 */
function ec_resp_151_process_maintenance_page(&$variables) {
 ...
 * Process html hook.
 */
function ec_resp_151_process_html(&$variables) {
 ...
 * Process page hook.
 */
function ec_resp_151_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 * Alter page header.
 */
function ec_resp_151_page_alter($page) {
  global $language;
  if (arg(0) == 'node') {
    $node = node_load(arg(1));
    if (isset($node->title)) {
 ...
 */
function ec_resp_151_block_view_alter(&$data, $block) {
 ...
 */
function ec_resp_151_form_element($variables) {
 ...
 */
function ec_resp_151_button($variables) {
  $element = $variables['element'];
 ...
 */
function ec_resp_151_menu_tree($variables) {
 ...
 */
function ec_resp_151_menu_tree__main_menu($variables) {
 ...
 */
function ec_resp_151_menu_link(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
 ...
 */
function ec_resp_151_menu_link__main_menu(array $variables) {
  $element = $variables['element'];
  $dropdown = '';
 ...
 */
function ec_resp_151_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 * Alter tabs.
 */
function ec_resp_151_menu_local_tasks(&$variables) {
  $output = '';
 ...
 * Hook form alter.
 */
function ec_resp_151_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
    case 'search_block_form':
      $form['search_block_form']['#attributes']['placeholder'][] = t('Search');

      $form['actions']['submit']['#type'] = 'image_button';
      $form['actions']['submit']['#src'] = drupal_get_path('theme', 'ec_resp_151') . '/images/search-button.png';
    ...
    case 'search_form':
      ...
      $form['basic']['submit']['#src'] = drupal_get_path('theme', 'ec_resp_151') . '/images/search-button.png';
  ...
  $form['#after_build'][] = 'ec_resp_151_cck_alter';
}

/**
 * After_build function for form_alter.
 */
function ec_resp_151_cck_alter($form, &$form_state) {
  // Hide format field.
 ...
 */
function ec_resp_151_link($variables) {
  $decoration = '';
  $action_bar_before = '';
  $action_bar_after = '';
  $btn_group_before = '';
 ...
 */
function ec_resp_151_dropdown($variables) {
 ...
 */
function ec_resp_151_block_render($module, $block_id) {
 ...
 */
function ec_resp_151_icon_type_classes($subject) {
  $pattern = '@<i class="icon-(.+)"></i>@';
  $resexp = preg_replace_callback($pattern, 'ec_resp_151_class_replace', $subject);
  return $resexp;
}
 ...
 */
function ec_resp_151_class_replace($match) {
  $output = '';
 ...
 */
function ec_resp_151_breadcrumb($variables) {
