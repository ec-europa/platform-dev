  ...
  */
  ...
  $node->body[$node->language][0]['value'] = 
   '<p>Notice:</p>
    ...
    <p>- to access the <strong>Feature set</strong> configuration page which helps you to choose the features you wish to install on your site &gt;&gt; <a href="'.$tmp_base_url.'/admin/structure/feature-set"><font color="#3366ff">click here</font></a></p>
    <p><font color="#000000">- to access the <strong>user creation</strong> page in order to add some users and to choose the role you wish to give them &gt;&gt;</font> <a href="'.$tmp_base_url.'/admin/people"><font color="#3366ff">click here</font></a></p>
    <p>&nbsp;</p>
    ...
    <p>Management will be done through the <strong>Workbench </strong>you can access thru this <a href="'.$tmp_base_url.'/admin/workbench"><font color="#3366ff">link</font></a>.</p>
  ...
  $obj_exports = unserialize($exports->config);
  db_insert('password_policy')
    ->fields(array(
      'name' => 'ten_characters',
      'config' => serialize($obj_exports),
    ))
    ->execute();
}
