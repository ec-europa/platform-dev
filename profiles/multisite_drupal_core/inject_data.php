...
function inject_data() {
  ...
  $node->body[$node->language][0]['value'] = 
   '<p>Notice:</p>
    <p>You have to login in order to perform any of the action described below &gt;&gt; <a href="'.$_SERVER['REQUEST_URI'].'/user">Login</a></p>
    <p>&nbsp;</p>
    <p>To complete the configuration of your site, here are&nbsp;some additional&nbsp;steps :</p>
    <p>- to access the <strong>Feature set</strong> configuration page which helps you to choose the features you wish to install on your site &gt;&gt; <a href="'.$_SERVER['REQUEST_URI'].'/admin/structure/feature-set"><font color="#3366ff">click here</font></a></p>
    <p><font color="#000000">- to access the <strong>user creation</strong> page in order to add some users and to choose the role you wish to give them &gt;&gt;</font> <a href="'.$_SERVER['REQUEST_URI'].'/admin/people"><font color="#3366ff">click here</font></a></p>
    <p>&nbsp;</p>
    ...
    <p>Management will be done through the <strong>Workbench </strong>you can access thru this <a href="'.$_SERVER['REQUEST_URI'].'/admin/workbench"><font color="#3366ff">link</font></a>.</p>
