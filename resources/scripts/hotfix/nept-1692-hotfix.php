...
function my_module_update_xxxx() {
  ...
  from "poetry_status" tables: @list.', ['@list' => implode(' ,', $tjiids)]);
  ...
  from "tmgmt_job_item" and "tmgmt_message" tables: @list.', ['@list' => implode(' ,', $tjids)]);
  ...
  from "tmgmt_job" table: @list.', ['@list' => implode(' ,', $tjids)]);
