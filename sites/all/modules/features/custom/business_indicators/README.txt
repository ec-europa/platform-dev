...
The Business Indicators Multisite feature provides a set of blocks with figures 
...
the site bu using the Context module. Views exposed by the feature are the following:
