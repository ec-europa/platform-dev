...
foreach($languages[1] as $lang) {
  ...
  if(isset($language_negociation['locale-url-suffix'])) {
    ...
    if($alias != $path)
      ...
      $path = drupal_get_path_alias(isset($translations[$language_default->language])?$translations[$language_default->language]:$path, $language_default->language).$suffix.$lang->prefix;
  }
  else {
