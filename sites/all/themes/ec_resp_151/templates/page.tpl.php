...
?>
  ...
  <?php
    switch ($variables['template']) {
      case 'ec':
  ?>
      <img alt="European Commission logo" id="banner-flag" src="<?php print $base_url . '/' . drupal_get_path('theme', 'ec_resp_151'); ?>/images/logo/logo_en.gif" />
    ...
    ?>
      <a class="banner-flag" href="http://europa.eu/index_en.htm" title="European Union homepage">
        <img id="banner-flag" src="<?php print $base_url . '/' . drupal_get_path('theme', 'ec_resp_151'); ?>/wel/template-2011/images/europa-flag.gif" alt="European Union homepage. EU flag" width="67" height="60" border="0">
      </a>

      <p class="banner-title">
        <img src="<?php print $base_url . '/' . drupal_get_path('theme', 'ec_resp_151'); ?>/wel/template-2011/images/title/title_en.gif" alt="Title of the site" width="450" height="46">
      </p>
...
<script type="text/javascript">
  var templatePath = "<?php print $base_url . '/' . drupal_get_path('theme', 'ec_resp_151'); ?>";
</script>